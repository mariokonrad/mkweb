...
int main(int argc, char ** argv)
{
	...
	auto cfg = std::make_shared<mkweb::config>(config_filename);
	...
	mkweb::system::reset(cfg);
	std::cout << "plugin path   =[" << mkweb::system::get_plugin_path("osm") << "]\n";
	std::cout << "plugin style  =[" << mkweb::system::get_plugin_style("osm") << "]\n";
	std::cout << "theme path    =[" << mkweb::system::get_theme_path() << "]\n";
	std::cout << "theme template=[" << mkweb::system::get_theme_template() << "]\n";
	std::cout << "theme style   =[" << mkweb::system::get_theme_style() << "]\n";
	std::cout << "theme footer  =[" << mkweb::system::get_theme_footer() << "]\n";
